...
VALUES
    ('DLSU-M Garage', '09171234567', 'DLSU.taft@park.com', 60, '2401 Taft Avenue, Manila 1004, Philippines', '06:00:00', '22:00:00'),
    ('Makati Central', '09178889999', 'makati@park.com', 60, 'Ayala Triangle, Makati City', '05:00:00', '23:00:00'),
    ('BGC High Street', '09177776666', 'bgc@park.com', 60, '9th Avenue, Taguig City', '00:00:00', '23:59:59');
...
VALUES
    ...
    ('2-P-1-001',2,1,'PWD',TRUE),
    ('2-P-1-002',2,1,'PWD',TRUE),
    ('2-P-1-003',2,1,'PWD',TRUE),
    ('2-P-1-004',2,1,'PWD',TRUE),
    ('2-P-1-005',2,1,'PWD',TRUE),
    ('2-V-1-006',2,1,'VIP',TRUE),
    ('2-V-1-007',2,1,'VIP',TRUE),
    ('2-V-1-008',2,1,'VIP',TRUE),
    ('2-V-1-009',2,1,'VIP',TRUE),
    ('2-V-1-010',2,1,'VIP',TRUE),
    ('2-M-1-011',2,1,'Motorcycle',TRUE),
    ('2-M-1-012',2,1,'Motorcycle',TRUE),
    ('2-M-1-013',2,1,'Motorcycle',TRUE),
    ('2-M-1-014',2,1,'Motorcycle',TRUE),
    ('2-M-1-015',2,1,'Motorcycle',TRUE),
    ('2-R-1-016',2,1,'Regular',TRUE),
    ('2-R-1-017',2,1,'Regular',TRUE),
    ('2-R-1-018',2,1,'Regular',TRUE),
    ('2-R-1-019',2,1,'Regular',TRUE),
    ('2-R-1-020',2,1,'Regular',TRUE),
    ('2-R-1-021',2,1,'Regular',TRUE),
    ('2-R-1-022',2,1,'Regular',TRUE),
    ('2-R-1-023',2,1,'Regular',TRUE),
    ('2-R-1-024',2,1,'Regular',TRUE),
    ('2-R-1-025',2,1,'Regular',TRUE),
    ('2-R-1-026',2,1,'Regular',TRUE),
    ('2-R-1-027',2,1,'Regular',TRUE),
    ('2-R-1-028',2,1,'Regular',TRUE),
    ('2-R-1-029',2,1,'Regular',TRUE),
    ('2-R-1-030',2,1,'Regular',TRUE),
    ('2-R-2-031',2,2,'Regular',TRUE),
    ('2-R-2-032',2,2,'Regular',TRUE),
    ('2-R-2-033',2,2,'Regular',TRUE),
    ('2-R-2-034',2,2,'Regular',TRUE),
    ('2-R-2-035',2,2,'Regular',TRUE),
    ('2-R-2-036',2,2,'Regular',TRUE),
    ('2-R-2-037',2,2,'Regular',TRUE),
    ('2-R-2-038',2,2,'Regular',TRUE),
    ('2-R-2-039',2,2,'Regular',TRUE),
    ('2-R-2-040',2,2,'Regular',TRUE),
    ('2-R-2-041',2,2,'Regular',TRUE),
    ('2-R-2-042',2,2,'Regular',TRUE),
    ('2-R-2-043',2,2,'Regular',TRUE),
    ('2-R-2-044',2,2,'Regular',TRUE),
    ('2-R-2-045',2,2,'Regular',TRUE),
    ('2-R-2-046',2,2,'Regular',TRUE),
    ('2-R-2-047',2,2,'Regular',TRUE),
    ('2-R-2-048',2,2,'Regular',TRUE),
    ('2-R-2-049',2,2,'Regular',TRUE),
    ('2-R-2-050',2,2,'Regular',TRUE),
    ('2-R-2-051',2,2,'Regular',TRUE),
    ('2-R-2-052',2,2,'Regular',TRUE),
    ('2-R-2-053',2,2,'Regular',TRUE),
    ('2-R-2-054',2,2,'Regular',TRUE),
    ('2-R-2-055',2,2,'Regular',TRUE),
    ('2-R-2-056',2,2,'Regular',TRUE),
    ('2-R-2-057',2,2,'Regular',TRUE),
    ('2-R-2-058',2,2,'Regular',TRUE),
    ('2-R-2-059',2,2,'Regular',TRUE),
    ('2-R-2-060',2,2,'Regular',TRUE),

    ('3-P-1-001',3,1,'PWD',TRUE), ('3-P-1-002',3,1,'PWD',TRUE), ('3-P-1-003',3,1,'PWD',TRUE), ('3-P-1-004',3,1,'PWD',TRUE), ('3-P-1-005',3,1,'PWD',TRUE),
    ('3-V-1-006',3,1,'VIP',TRUE), ('3-V-1-007',3,1,'VIP',TRUE), ('3-V-1-008',3,1,'VIP',TRUE), ('3-V-1-009',3,1,'VIP',TRUE), ('3-V-1-010',3,1,'VIP',TRUE),
    ('3-M-1-011',3,1,'Motorcycle',TRUE), ('3-M-1-012',3,1,'Motorcycle',TRUE), ('3-M-1-013',3,1,'Motorcycle',TRUE), ('3-M-1-014',3,1,'Motorcycle',TRUE), ('3-M-1-015',3,1,'Motorcycle',TRUE),
    ('3-R-1-016',3,1,'Regular',TRUE), ('3-R-1-017',3,1,'Regular',TRUE), ('3-R-1-018',3,1,'Regular',TRUE), ('3-R-1-019',3,1,'Regular',TRUE), ('3-R-1-020',3,1,'Regular',TRUE),
    ('3-R-1-021',3,1,'Regular',TRUE), ('3-R-1-022',3,1,'Regular',TRUE), ('3-R-1-023',3,1,'Regular',TRUE), ('3-R-1-024',3,1,'Regular',TRUE), ('3-R-1-025',3,1,'Regular',TRUE),
    ('3-R-1-026',3,1,'Regular',TRUE), ('3-R-1-027',3,1,'Regular',TRUE), ('3-R-1-028',3,1,'Regular',TRUE), ('3-R-1-029',3,1,'Regular',TRUE), ('3-R-1-030',3,1,'Regular',TRUE),
    ('3-R-2-031',3,2,'Regular',TRUE), ('3-R-2-032',3,2,'Regular',TRUE), ('3-R-2-033',3,2,'Regular',TRUE), ('3-R-2-034',3,2,'Regular',TRUE), ('3-R-2-035',3,2,'Regular',TRUE),
    ('3-R-2-036',3,2,'Regular',TRUE), ('3-R-2-037',3,2,'Regular',TRUE), ('3-R-2-038',3,2,'Regular',TRUE), ('3-R-2-039',3,2,'Regular',TRUE), ('3-R-2-040',3,2,'Regular',TRUE),
    ('3-R-2-041',3,2,'Regular',TRUE), ('3-R-2-042',3,2,'Regular',TRUE), ('3-R-2-043',3,2,'Regular',TRUE), ('3-R-2-044',3,2,'Regular',TRUE), ('3-R-2-045',3,2,'Regular',TRUE),
    ('3-R-2-046',3,2,'Regular',TRUE), ('3-R-2-047',3,2,'Regular',TRUE), ('3-R-2-048',3,2,'Regular',TRUE), ('3-R-2-049',3,2,'Regular',TRUE), ('3-R-2-050',3,2,'Regular',TRUE),
    ('3-R-2-051',3,2,'Regular',TRUE), ('3-R-2-052',3,2,'Regular',TRUE), ('3-R-2-053',3,2,'Regular',TRUE), ('3-R-2-054',3,2,'Regular',TRUE), ('3-R-2-055',3,2,'Regular',TRUE),
    ('3-R-2-056',3,2,'Regular',TRUE), ('3-R-2-057',3,2,'Regular',TRUE), ('3-R-2-058',3,2,'Regular',TRUE), ('3-R-2-059',3,2,'Regular',TRUE), ('3-R-2-060',3,2,'Regular',TRUE);
...
VALUES
    ...
    (1, 'VIP', 50.00, 50.00),
    (2, 'Regular', 40.00, 100.00),
    (2, 'PWD', 10.00, 40.00),
    (2, 'Motorcycle', 20.00, 40.00),
    (2, 'VIP', 100.00, 200.00),
    (3, 'Regular', 50.00, 100.00),
    (3, 'PWD', 10.00, 50.00),
    (3, 'Motorcycle', 25.00, 50.00),
    (3, 'VIP', 150.00, 300.00);
