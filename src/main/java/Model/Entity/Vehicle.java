...
public class Vehicle {
     ...
     * @param vehicle_id The unique ID of the vehicle (PK)
     * @param user_id The ID of the user who owns this vehicle (FK)
     * @param plate_number The vehicle's unique license plate number
     * @param vehicle_type The type of vehicle
     * @param vehicle_brand The manufacturer of the vehicle
     */
