 ...
 * Represents a physical car park location and its operational properties.
 */
public class Branch {
     ...
     * @param branch_ID The unique ID of the branch (PK)
     * @param name The name of the branch
     * @param contact_number The contact phone number for the branch
     * @param email The contact email address for the branch
     * @param max_slots The maximum number of slots available in this branch
     * @param location The address of the branch
     * @param opening_time The time the branch opens
     * @param closing_time The time the branch closes
     */
