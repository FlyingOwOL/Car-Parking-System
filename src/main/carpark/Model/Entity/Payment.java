...
public class Payment {
     ...
     */
    public Payment(int transact_ID, BigDecimal amount_to_pay, BigDecimal amount_paid, LocalDate payment_date, PaymentStatus payment_status, ModeOfPayment mode_of_payment) {
     ...
     * @param mode_of_payment The payment method used
     */
    public Payment(int payment_ID, int transact_ID, BigDecimal amount_to_pay, BigDecimal amount_paid, LocalDate payment_date, PaymentStatus payment_status, ModeOfPayment mode_of_payment) {
    ...
    public BigDecimal getAmount_To_Pay() { return amount_to_pay; }
    public void setAmount_To_Pay(BigDecimal amount_to_pay) { this.amount_to_pay = amount_to_pay; }
